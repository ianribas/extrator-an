...
if __name__ == "__main__":
    ...
    cookies = dict(ASPSESSIONIDCCBQCQSR='EEPJMIIDAOLDBMOABLJODJAJ',ASPSESSIONIDACCRCQSQ='BPKADPKDIEABCDGGLBAAHEAK',TS01dc25d1='01770c3a9841dbb80f087c5796c0c8a70c918eb8b9a5fb7229d46b84e736c80391564a8a27de44504d56d751444c19f2040f128a02c04b95e7951acf7b4448895e221d9514')
        ...
        with open('{}/{}.csv'.format(serie, serie), 'w', newline='') as f:
            ...
            while pagina <= num_pgs:
                ...
                for li in ulres.find_all('li'):
                    ...
                    # print('Dados:', description, arq_name, link)
